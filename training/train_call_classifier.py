"""Train XGBoost fraud classifier for phone call transcripts.

Combines handcrafted features (18 dims) with TF-IDF features (500 dims)
to produce a 518-dimensional feature vector per sentence, then trains an
XGBoost binary classifier.

Usage
-----
    python training/train_call_classifier.py \
        ...
        [--output models/call_fraud_xgb.json]
"""
...
def train_classifier(
    ...
    """Train an XGBoost call fraud classifier.
    ...
    tfidf_path : str
        Path to fitted TF-IDF vectorizer.
    output_path : str
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Train XGBoost call fraud classifier."
    )
    parser.add_argument(
        "--train-csv",
    ...
    parser.add_argument(
        "--output",
        default="models/call_fraud_xgb.json",
